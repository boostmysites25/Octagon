    ...
    <section className="py-[3rem] bg-backgroundcolor">
      <div className="wrapper text-center text-primarytextcolor flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            At Octagon Software Solutions, we’re dedicated to delivering
            AI-powered solutions that are custom-fit to your business needs. Our
            team is passionate about innovation and collaborates closely with
            you to understand your vision, transforming it into a digital
            reality that not only meets but exceeds expectations, driving growth
            and success.
          </p>
          {/* <div
            data-aos-offset={-400}
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  A reputable IT company, Octagon Software Solutions specializes
                  in crafting innovative, tailored solutions that align with
                  your business goals.
                </p>
              </div>
              <div
