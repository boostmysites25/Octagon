    ...
    <div className="py-[2rem] sm:py-[5rem] bg-backgroundcolor text-primarytextcolor">
      ...
      >
        ...
        <p data-aos="fade-up" className="desc max-w-[50rem]">
          At Octagon Software Solutions, we specialize in harnessing the power
          of artificial intelligence to craft innovative technology solutions
          that empower businesses to thrive. By leveraging AI-driven insights
          and automation, we tailor our services to align with your vision,
          enabling smarter decision-making, enhanced efficiency, and
